  ...
  return (
    <div className="mt-[60px]">
      <h2 className="text-[32px] font-semibold" data-aos="fade-up" data-aos-delay="50">
        Pendidikan <span className="text-theme">Formal:</span>
      </h2>
      <div className="items mt-[40px] grid gap-[40px]">
        <div className="item relative grid gap-[40px] border-l-[2px] border-text pb-[16px] pl-[35px]">
          ...
          {educations.map((edu) => (
            <div key={edu.degree}>
              <p className="text-text" data-aos="fade-up" data-aos-delay="100">{edu.period}</p>
              <h3
              ...
              <p className="mt-[5px] text-[18px] font-medium text-text" data-aos="fade-up" data-aos-delay="200">
                {edu.institution}
              </p>
              <p className="mt-[15px] text-text" data-aos="fade-up" data-aos-delay="250">
                {edu.desc}
              </p>
            </div>
          ))}
